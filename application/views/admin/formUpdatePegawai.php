    	...
    	<div class="card-body">
    		...
    		<form method="POST" action="<?php echo base_url('admin/dataPegawai/updateDataAksi') ?>" enctype="multipart/form-data">
    			<div class="form-group">
    				...
    				<?php echo form_error('nik','<div class="text_small text_danger"></div>') ?>
    			</div>

    			<div class="form-group">
    				<label>Nama Pegawai</label>
    				<input type="text" name="nama_pegawai" class="form-control" value="<?php echo $p->nama_pegawai ?>">
    				<?php echo form_error('nama_pegawai','<div class="text_small text_danger"></div>') ?>
    			</div>

                <div class="form-group">
                    <label>Username</label>
                    <input type="text" name="username" class="form-control" value="<?php echo $p->username ?>">
                    <?php echo form_error('username','<div class="text_small text_danger"></div>') ?>
                </div>

                <div class="form-group">
                    <label>Password</label>
                    <input type="password" name="password" class="form-control" value="<?php echo $p->password ?>">
                    <?php echo form_error('password','<div class="text_small text_danger"></div>') ?>
                </div>
    			...
    			<div class="form-group">
    				...
    				<?php echo form_error('jenis_kelamin','<div class="text_small text_danger"></div>') ?>
    			</div>
    			...
    			<div class="form-group">
    				...
    				<?php echo form_error('tanggal_masuk','<div class="text_small text_danger"></div>') ?>
    			</div>
    			...
    			<div class="form-group">
    				...
    				<?php echo form_error('jabatan','<div class="text_small text_danger"></div>') ?>
    			</div>

    			<div class="form-group">
    				<label>Photo</label>
    				<input type="file" name="photo" class="form-control">
    				<?php echo form_error('photo','<div class="text_small text_danger"></div>') ?>
    			</div>
